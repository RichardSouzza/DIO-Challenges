...
o saldo disponível em seu plano. Para essa solução, você pode criar uma classe PlanoTelefone, o
seu método de inicialização e encapsular os atributos, 'nome' e 'saldo' dentro da classe.
Adicione também um método 'verificar_saldo' para verificar o saldo do plano e uma
...
class UsuarioTelefone:
    ...
    def verificar_saldo(self):
        ...
        mensagem = self.plano.mensagem_personalizada(saldo)
