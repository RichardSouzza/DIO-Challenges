...
Crie uma função chamada recomendar_plano para receber o consumo médio mensal de
dados informado pelo cliente, além de utilizar estruturas condicionais para
...
def recomendar_plano(consumo):
    if consumo <= 10:
        return planos.get("essencial")
    elif 10 < consumo and consumo <= 20:
        return planos.get("prata")
    elif 20 < consumo:
        return planos.get("premium")
